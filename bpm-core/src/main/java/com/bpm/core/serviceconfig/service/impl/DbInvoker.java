...
public class DbInvoker {
    ...
    public DbInvoker(DbServiceConfigService dbService, DataSourceConfigService dataSourceService, ServiceLogService logService, PlatformTransactionManager txManager) {
